...
const F = D((e, t) => ({
    ...
    es = ({
        ...
        return l.jsx("div", {
            className: O("sf:w-dvw sf:h-dvh sf:rounded-none sf:shadow-none", "sf:sm:w-[420px] sf:sm:h-[680px] sf:sm:max-h-[calc(100vh-56px-2*var(--sf-hem))] sf:sm:rounded-2xl sf:sm:shadow-widget"),
            children: c()
        })
    },
    ss = new Set(["line"]);
...
const us = () => {
    ...
    fs = () => {
        ...
        return a ? l.jsx("div", {
            className: O("sf:absolute sf:bottom-21 sf:right-4 sf:w-[260px] sf:transform sf:transition-all sf:duration-300 sf:ease-in-out sf:opacity-100 sf:translate-y-0 sf:scale-100", "sf:sm:bottom-17 sf:sm:right-0"),
            children: l.jsx("div", {
...
const ws = () => {
    ...
    Ss = () => {
        ...
        return l.jsx("button", {
            onClick: a,
            className: O("sf:absolute sf:bottom-4 sf:right-4 sf:group sf:bg-widget-button-color sf:rounded-full sf:shadow-lg sf:flex sf:items-center sf:justify-center sf:transition-all sf:duration-300 sf:ease-in-out sf:hover:shadow-xl sf:hover:scale-110 sf:focus:outline-none sf:focus:ring-4 sf:focus:ring-blue-20 sf:focus:ring-opacity-50 sf:cursor-pointer", "sf:sm:bottom-0 sf:sm:right-0"),
...
const Ds = () => {
    ...
    ks = () => {
        ...
        const a = e(),
            o = r.useMemo(() => {
                if (n.buttonColor) return {
                    "--sf-color-widget-background-color": `${n.buttonColor}40`,
                    "--sf-color-widget-button-color": n.buttonColor,
                    "--sf-color-widget-button-color-dimmed": `${n.buttonColor}10`,
                    "--sf-color-widget-message-background-color": n.messageBackgroundColor,
                    "--sf-color-widget-message-text-color": ce(n.messageBackgroundColor),
                    "--sf-color-widget-button-text-color": ce(n.buttonColor)
                }
            }, [n]);
        return r.useEffect(() => (a ? document.body.classList.add("sf:prevent-scroll") : document.body.classList.remove("sf:prevent-scroll"), () => {
            ...
            className: O("sf:fixed sf:z-9000 sf:bottom-0 sf:right-0", "sf:sm:bottom-80 sf:sm:right-8"),
            style: o,
